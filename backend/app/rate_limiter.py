...
class RateLimiter:
    ...
    def __init__(self):
        ...
        # Configuration
        self.max_requests_per_minute = 30  # Increased limit for dev
        self.max_failures_before_block = 10  # Increased failure tolerance
        self.failure_block_duration = 10  # Short block duration
